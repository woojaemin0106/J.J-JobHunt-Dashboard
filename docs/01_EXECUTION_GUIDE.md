...
## EG-11 Gate 1+2 �Ϸ� �ٰ� (2026-03-26)

### ����
- Gate 1(ǰ�� ����ȭ), Gate 2(��� Ȯ��) ���� ����� ���� ����� ����� ����Ѵ�.

### ���� ����
- �� �귣ġ(`feat/gate1-gate2-stability`)���� Gate 1+2 �ݿ� Ŀ���� �и��Ǿ� �����ǰ� �ִ�.
- lint/build�� ���� ���� ��� ���´�.

### �������� ��Ģ
- �Ʒ� ǥ�� Gate �Ϸ� ����� �ּ� �������� �����Ѵ�.
- ��å ID ������ `BP-08`, `BP-09`, `BP-12`, `BP-13`�� �⺻ ������ �����Ѵ�.

| Gate | ���� �׸� | �ٰ� Ŀ��(���) | ��å ID |
|---|---|---|---|
| Gate 1 | ������ lint ����(no-unused-vars, any ����) | `fix: resolve low-risk lint issues in auth and forms` | BP-11, BP-13 |
| Gate 1 | set-state-in-effect ���� | `refactor: remove set-state-in-effect from applications modal flow` | BP-11 |
| Gate 1 | store ���� ESLint ���� ��ȭ | `chore: relax react-refresh rule for store context modules` | BP-13 |
| Gate 2 | ���� ��� ����(�ߺ� Provider ����, ����/��ȣ ���Ʈ) | `feat: add route guards and remove duplicate auth provider` | BP-09 |
| Gate 2 | user ������ ���� Ű + 1ȸ ���̱׷��̼� | `feat: scope persisted data by user with one-time migration` | BP-08 |
| Gate 2 | ���� ó�� ����/�α� ���� ���� | `refactor: standardize auth error messages and safe diagnostics` | BP-12 |

### ���� ����� üũ����Ʈ
- [x] ������ ����ڴ� `/login`, `/signup`�� ���� �����ϰ� ��ȣ ���Ʈ ���� �� `/login`���� �����̷�Ʈ�ȴ�.
- [x] ���� ����ڴ� `/login`, `/signup` ���� �� `/`�� �����̷�Ʈ�ȴ�.
- [x] `ApplicationModal`�� �ű�/���� ����, �ݱ�, URL `?new=true` ������ �����ȴ�.
- [x] `localStorage`�� `jj.jobhunt.{resource}.v2.user:{scope}` �������� ����ȴ�.
- [x] ���Ž� Ű(`jj_jobhunt_*_v1`)���� �ű� Ű�� 1ȸ �̰� �� �ߺ� �̰��� �����ȴ�.
- [x] ����/���� ���� �޽����� ���� �ൿ �߽� ������ ����Ѵ�.
- [x] `npm run lint`, `npm run build`�� ����Ѵ�.

### ���� ����
- [ ] Gate 1/2 �Ϸ� PR ������ �� ���� ��ũ�� ���� ���� ǥ�� ���Եȴ�.
- [ ] ���� ȸ�� �߻� �� �� üũ����Ʈ �׸� ȸ�� ���̽��� �߰��Ѵ�.
- [ ] ��å ������ ����ġ �׸��� �߰ߵǸ� ADR �Ǵ� ��å �������� ����ȭ�Ѵ�.
