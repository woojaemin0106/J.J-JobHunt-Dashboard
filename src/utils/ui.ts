...
export const ui = {
  ...
  btnPrimary:
    "inline-flex items-center justify-center gap-2 rounded-[var(--jj-radius-lg)] border border-transparent bg-[color:var(--jj-color-brand)] px-4 py-2 text-sm font-semibold text-white shadow-[var(--jj-shadow-soft)] transition duration-200 hover:bg-[color:var(--jj-color-brand-strong)] motion-safe:hover:-translate-y-px motion-safe:active:translate-y-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--jj-color-brand)]/35 focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:cursor-not-allowed disabled:opacity-60",
  btnSecondary:
    "inline-flex items-center justify-center gap-2 rounded-[var(--jj-radius-lg)] border border-[color:var(--jj-color-line)] bg-white px-4 py-2 text-sm font-semibold text-[var(--jj-color-ink)] shadow-[0_1px_0_rgba(15,23,42,0.02)] transition duration-200 hover:border-slate-300 hover:bg-slate-50 motion-safe:hover:-translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-300/70 focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:cursor-not-allowed disabled:opacity-60",
  btnOnDark:
    "inline-flex items-center justify-center gap-2 rounded-[var(--jj-radius-lg)] border border-white/25 bg-white/12 px-4 py-2 text-sm font-bold text-white backdrop-blur transition duration-200 hover:bg-white/20 motion-safe:hover:-translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 disabled:cursor-not-allowed disabled:opacity-60",
  btnDanger:
    "inline-flex items-center justify-center gap-2 rounded-[var(--jj-radius-lg)] border border-rose-200 bg-rose-50 px-4 py-2 text-sm font-semibold text-rose-700 transition duration-200 hover:bg-rose-100 motion-safe:hover:-translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-300/80 focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:cursor-not-allowed disabled:opacity-60",
  actionText:
    "inline-flex items-center rounded-md px-1.5 py-1 text-xs font-semibold text-slate-500 transition duration-150 hover:text-slate-900 hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--jj-color-brand)]/30 focus-visible:ring-offset-2",
